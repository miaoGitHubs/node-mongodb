...
describe('DELETE /todos/:id', () =>{
	...
	it('should return 404 if object id is invalid', (done) =>{
          request(app)
			.delete('/todos/123abc')//invalid id
            .expect(404)
            .expect((res)=>{
            	expect(res.body.todo.id).toBe()
            })
...
describe('PATCH /todos/:id', () =>{
	...
	it('should clear completedAt wheb todo is not completed', (done) => {
        var id = todo[2]._id.toHexString();
        var text = 'This should be the new text!!';
...
describe("POST /users", ()=>{
	it('should create a user',(done)=>{
        ...
        .expect(200)
        .expect((res)=>{
        	expect(res.headers['x-auth']).tiExist();
